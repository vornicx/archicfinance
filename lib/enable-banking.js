...
const APP_ID = "970d115b-18dd-4f1d-b5ce-1fd0d73998a4";
const APP_URL = "https://archicfinance.vercel.app";
...
export async function startRevolutAuth() {
  ...
  return ebFetch("/auth", {
    ...
    body: JSON.stringify({
      ...
      redirect_url: `${APP_URL}/api/callback`,
      psu_type: "personal",
      language: "es",
...
export async function getTransactions(accountId, dateFrom, dateTo, transactionStatus = "BOOK") {
  const out = [];
